			...
			if ( ! empty( $data ) ) {
				foreach ( $data as $d ) {
					...
					if ( 'plugin' === $d->type ) {
						...
						if ( $d->require_woocommerce && ! in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
							continue;
						}
							...
							<div class="plugin-card">
								<div class="plugin-card-top">
									<div class="name column-name">
										...
										<h3>
											<a href="<?php echo esc_html( $d->button_primary['url'] ); ?>?utm_source=wp_<?php echo $this->current; ?>&utm_medium=onboarding_upsell&utm_campaign=upsell" target="_blank">
								...
								<div class="plugin-card-bottom">
									...
									<?php if ( $d->button_primary2 ) : ?>
										<a href="<?php echo esc_url( $d->button_primary2['url'] ); ?>?utm_source=wp_<?php echo esc_attr( $this->current ); ?>&utm_medium=onboarding_upsell&utm_campaign=upsell" target="_blank" class="button-primary">
											<?php echo esc_html( $d->button_primary2['text'] ); ?>
										</a>
									<?php endif; ?>
								</div>
							</div>
